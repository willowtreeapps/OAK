...
public class ImageManagerTestActivity extends ListActivity {
                    ...
                    public void run() {
                        OAKImageLoader.start(photoItem.getURL(), new OAKImageLoaderHandler(imageView, photoItem.getURL()) {
							...
							public boolean handleImageLoaded(Bitmap bitmap, Message msg) {
                                ...
                                if (didLoad) {
                                    thumbnailCache.put(this.getPrintedUrl(), bitmap);
                                }
                                return didLoad;
                            }
							...
							public Bitmap transform(Bitmap image) {
                        		// Scales the image down to 100x100, draws a green dot in the middle
							...
							@Override
							public String fingerprint() { return "scaledot"; }
                        } );
                    }
                } );
            }
    ...
    /**
     * Temporary ad-hoc XML parser
     * Scans the HTML String to find attributes requested
     *
